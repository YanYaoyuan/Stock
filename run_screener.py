...
用法:
  ...
  python run_screener.py --sentiment            # 开启情绪过滤
  python run_screener.py --sentiment --market   # 开启情绪+查看市场情绪
"""
...
def main():
    ...
    if args.sentiment or args.market:
        try:
            ...
            print(f"❌ 情绪模块导入失败: {e}")
            print("   请确保已安装 requests: pip install requests")
            return
    ...
    # 选股
    mode_str = "基本面+情绪" if args.sentiment else "纯基本面"
    ...
    with BaostockDataSource() as ds:
        ...
        passed = screener.screen(pool, sentiment_engine=sentiment_engine if args.sentiment else None)
        ...
        suffix = "_sentiment" if args.sentiment else ""
